...
<br/>
<strong>Remark.</b>. If we assume $\AC$, then this exercise becomes far easier as countable union of countable sets is countable (which makes proving <a href="#lem4.3.A">Lemma 4.3.A</a> slightly easier), and every set is well-orderable (trivialising <a href="#lem4.3.B">Lemma 4.3.B</a>).<br/>
<br/>
<a name="ex4.4"></a><br/>
<h2>Exercise 4.4.</h2>
...
<strong>Lemma 4.6.A.</b> Every open set of reals is a countable union of disjoint open intervals.<br/>
<br/>
<strong>Note.</b>. For this exercise, we use $(a,b)$ to denote the open interval, and $\c{a,b}$ to denote ordered pair.<br/>
<br/>
