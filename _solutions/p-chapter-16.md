...
<a name="ex16.8"></a><br/>
<h2>Exercise 16.8.</h2>
<i>Solution.</i> Let $P_\alpha$ be the finite support iteration uniquely determined by a sequence of forcing notions $\c{\dot{Q}_\beta : \beta < \alpha}$.<br/>
<br/>
...
<a name="ex16.9"></a><br/>
<h2>Exercise 16.9.</h2>
<i>Solution.</i> Since a finite support iteration is in particular an iteration (Definition 16.29), this is a special case of <a href="#ex16.17">Exercise 16.17</a>.<p align="right">$\square$</p><br/>
<br/>
<a name="ex16.10"></a><br/>
