...
<div class="semester-section">
  <a name="ex6.1"></a>
  <h3 class="semester-title">Exercise 6.1</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We induct on $\rank(x)$. If $\rank(x) = 0$, then $\lbrace \rank(z) + 1 : z \in x\rbrace = \emptyset$, so $\sup\lbrace \rank(z) + 1 : z \in x\rbrace = 0$.<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex6.2"></a>
  <h3 class="semester-title">Exercise 6.2</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We induct on $\alpha$ on the second assertion. For the base case $\alpha = 0$, we note that $V_\omega = \bigcup_{n < \omega} V_n$, and it's easy to see that $\vert V_{n+1}\vert  = 2^{\vert V_n\vert }$. Thus, $V_\omega$ is a countable union of finite sets, hence:
    $$
    \begin{align*}
...
<div class="semester-section">
  <a name="ex6.3"></a>
  <h3 class="semester-title">Exercise 6.3</h3>
  <div class="lemma-box">
    <a name="lem6.3.A"></a>
    <span class="status-badge lemma">Lemma 6.3.A</span>
    <br/>
    If $\kappa$ is uncountable inaccessible, then $\kappa = \aleph_\kappa = \beth_\kappa$.
    <hr/>
    <span class="status-badge lemma">Proof</span>
    <br/>
    Note that clearly $\kappa \leq \aleph_\kappa \leq \beth_\kappa$. To show that $\beth_\kappa \leq \kappa$, since $\beth_\kappa = \sup\lbrace \beth_\alpha : \alpha < \kappa\rbrace$, it suffices to show that if $\alpha < \kappa$ then $\beth_\alpha < \kappa$.<br/>
    <br/>
    We prove this by transfinite induction.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Since $\kappa$ is uncountable, $\beth_0 = \aleph_0 < \kappa$.</li>
      <li style="margin-bottom: 6px;">If $\beth_\alpha < \kappa$, then since $\kappa$ is a strong limit, we have that $\beth_{\alpha+1} = 2^{\beth_\alpha} < \kappa$.</li>
      <li style="margin-bottom: 6px;">If $\alpha$ is a limit ordinal, then $\sup\lbrace \beth_\beta : \beta < \alpha\rbrace \leq \kappa$. Since $\kappa$ is regular and $\alpha < \kappa$, then inequality must be strict.</li>
    </ol>
  ...
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    If $\kappa = \omega$, then $\vert V_\omega\vert  = \aleph_0$ by <a href="#ex6.2">Exercise 6.2</a>. Otherwise, since $\kappa$ is uncountable we have $\omega + \kappa = \kappa$ (here addition is ordinal addition). Thus, by <a href="#ex6.2">Exercise 6.2</a> and <a href="#lem6.3.A">Lemma 6.3.A</a>, we have $\vert V_\kappa\vert  = \beth_\kappa$.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex6.4"></a>
  <h3 class="semester-title">Exercise 6.4</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We can do better. We show that if $\rank(x) = \alpha$ and $\rank(y) = \beta$, then:
    <table style="margin: 16px auto; border-collapse: collapse; font-size: 15px;">
      <thead>
        <tr>
          <th style="padding: 8px 24px; border-bottom: 1px solid var(--border-color); text-align: center;">Set</th>
          <th style="padding: 8px 24px; border-bottom: 1px solid var(--border-color); text-align: center;">Rank</th>
        </tr>
      </thead>
      <tbody>
        <tr><td style="padding: 6px 24px; text-align: center;">$\lbrace x,y\rbrace$</td><td style="padding: 6px 24px; text-align: center;">$\max\lbrace\alpha,\beta\rbrace + 1$</td></tr>
        <tr><td style="padding: 6px 24px; text-align: center;">$\c{x,y}$</td><td style="padding: 6px 24px; text-align: center;">$\max\lbrace\alpha,\beta\rbrace + 2$</td></tr>
        <tr><td style="padding: 6px 24px; text-align: center;">$x \cup y$</td><td style="padding: 6px 24px; text-align: center;">$\max\lbrace\alpha,\beta\rbrace$</td></tr>
        <tr><td style="padding: 6px 24px; text-align: center;">$\bigcup x$</td><td style="padding: 6px 24px; text-align: center;">$\bigcup \alpha$</td></tr>
        <tr><td style="padding: 6px 24px; text-align: center;">$P(x)$</td><td style="padding: 6px 24px; text-align: center;">$\alpha + 1$</td></tr>
        <tr><td style="padding: 6px 24px; text-align: center;">$x^y$</td><td style="padding: 6px 24px; text-align: center;">$\max\lbrace\alpha,\beta\rbrace$</td></tr>
      </tbody>
    </table>
...
<div class="semester-section">
  <a name="ex6.5"></a>
  <h3 class="semester-title">Exercise 6.5</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    While these sets do not have universally agreed set-theoretic definitions, it is sufficient to define $\Z$, $\Q$ and $\R$ in $V_{\omega+\omega}$ in their "intended way".<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex6.6"></a>
  <h3 class="semester-title">Exercise 6.6</h3>
  <a name="ex6.6(i)"></a>
  <p class="sub-exercise-title">Exercise 6.6(i)</p>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We induct on $\rank(x)$. Since $V_0 = \emptyset$, the base case is trivial. Suppose the statement holds for ranks $\beta < \alpha$, and suppose $\rank(x) = \alpha$.<br/>
    <br/>
  ...
  <a name="ex6.6(ii)"></a>
  <p class="sub-exercise-title">Exercise 6.6(ii)</p>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $C \subseteq A$ be another transitive class. We induct on $\rank(x)$ showing that if $x \in C$, then $x \in B$. Again, base case is trivial, so suppose the statement holds for ranks $\beta < \alpha$, and suppose $\rank(x) = \alpha$.<br/>
    <br/>
