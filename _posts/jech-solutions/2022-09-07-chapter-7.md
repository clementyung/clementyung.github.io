...
<div class="semester-section">
  <a name="ex7.1"></a>
  <h3 class="semester-title">Exercise 7.1</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We check the axioms.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Clearly $X \in P(X) \cap F$ and $\emptyset \notin P(X) \cap F$.</li>
      <li style="margin-bottom: 6px;">Let $Y,Z \in P(X) \cap F$. Then $Y,Z \subseteq P(X)$ i.e. $Y,Z \subseteq X$. Then $Y \cap Z \subseteq X$. Since $F$ is a filter, $Y \cap Z \in F$. Thus, $Y \cap Z \in P(X) \cap F$.</li>
      <li style="margin-bottom: 6px;">Let $Y \in P(X) \cap F$ and let $Z \subseteq X$ such that $Y \subseteq Z$. Then immediately $Z \in P(X)$. On the other hand, since $F$ is a filter, $Z \in F$. Thus, $Z \in P(X) \cap F$.</li>
    </ol>
...
<div class="semester-section">
  <a name="ex7.4"></a>
  <h3 class="semester-title">Exercise 7.4</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let:
    ...
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Let $Y,Z \subseteq S$. Then for all $a \in Y$, we have $\lbrace b \in S : (a,b) \in Y \times Z\rbrace = Z \in U$, so $\lbrace a \in S : \lbrace b \in S : (a,b) \in Y \times Z\rbrace \in U\rbrace \in U$. Thus, $Y \times Z \in U'$, and in particular $S \times S \in U'$.</li>
      <li style="margin-bottom: 6px;">Suppose $X \in U'$, and let $X \subseteq X' \subseteq S \times S$. Then for all $a \in S$, we have $\lbrace b \in S : (a,b) \in X'\rbrace \supseteq \lbrace b \in S : (a,b) \in X'\rbrace$, so $\lbrace b \in S : (a,b) \in X'\rbrace \in U$ by upward closure of $U$. In other words, we have:
        $$
        \begin{align*}
      ...
      <li style="margin-bottom: 6px;">Let $X,X' \in U'$. It's easy to see that for all $a \in S$:
        $$
        \begin{align*}
...
<div class="semester-section">
  <a name="ex7.5"></a>
  <h3 class="semester-title">Exercise 7.5</h3>
  <div class="lemma-box">
    <a name="lem7.5.A"></a>
    <span class="status-badge lemma">Lemma 7.5.A</span>
    <br/>
    Let $U$ be a filter on a set $S$. Then $U$ is an ultrafilter iff for all $X,Y \subseteq S$, if $X \cup Y \in U$ then $X \in U$ or $Y \in U$.
    <hr/>
    <span class="status-badge lemma">Proof</span>
    <br/>
    <u>$\implies$:</u> Let $X,Y \subseteq S$ such that $X \cup Y \in U$. Suppose $X \notin U$ and $Y \notin U$. Since $U$ is an ultrafilter, $S - X,S - Y \in U$. Thus $(S - X) \cap (S - Y) = S - (X \cup Y) \in U$. This contradicts that $X \cup Y \in U$.<br/>
    <br/>
  ...
  <div class="solution-box">
    ...
    We verify the axioms.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">We have $f_{-1}(T) = S \in U$, so $T \in f_*(U)$.</li>
      <li style="margin-bottom: 6px;">Let $X,Y \in f_*(U)$, so $f_{-1}(X),f_{-1}(Y) \in U$. Then $f_{-1}(X) \cap f_{-1}(Y) = f_{-1}(X \cap Y) \in U$, so $X \cap Y \in U$.</li>
      <li style="margin-bottom: 6px;">Let $X \in f_*(U)$ and suppose $X \subseteq Y$. Then $f_{-1}(X) \subseteq f_{-1}(Y)$, and since $f_{-1}(X) \in U$ we have that $f_{-1}(Y) \in U$. Thus $Y \in f_*(U)$.</li>
      <li style="margin-bottom: 6px;">Let $X \subseteq T$. Observe that $f_{-1}(X) \cup f_{-1}(T - X) = f_{-1}(T) = S \in U$. By <a href="#lem7.5.A">Lemma 7.5.A</a>, we have $f_{-1}(X) \in U$ or $f_{-1}(T - X) \in U$. Thus $X \in f_*(U)$ or $T - X \in f_*(U)$.</li>
    </ol>
...
<div class="semester-section">
  <a name="ex7.6"></a>
  <h3 class="semester-title">Exercise 7.6</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    For each $X \subseteq \boldsymbol{N}$, let $S_X := \lbrace a_n : n \in X\rbrace$. Let:
    $$
    \begin{align*}
...
<div class="semester-section">
  <a name="ex7.7"></a>
  <h3 class="semester-title">Exercise 7.7</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    <u>$\implies$:</u> Let $A_0 \supseteq A_1 \supseteq \dots \supseteq A_n \subseteq \dots$ be a decreasing sequence of elements of $D$. We may assume WLOG that it is strictly decreasing. For each $n \in \omega$ we define $B_n$ by $B_0 := \boldsymbol{N} - A_0$, and $B_{n+1} := A_n - A_{n+1}$. Now consider:
    $$
    \begin{align*}
...
<div class="semester-section">
  <a name="ex7.8"></a>
  <h3 class="semester-title">Exercise 7.8</h3>
  <div class="lemma-box">
    <a name="lem7.8.A"></a>
    <span class="status-badge lemma">Lemma 7.8.A</span>
    <br/>
    For any countable linearly ordered set $(P,<)$, there exists a subset $X \subseteq \Q$ such that $(P,<) \cong (X,<)$, where $<$ in $(X,<)$ is the usual order of rationals.
    <hr/>
    <span class="status-badge lemma">Proof</span>
    <br/>
    Write $P = \lbrace p_n : n < \omega\rbrace$. Define $q_n \in \Q$ as follows: Let $q_0$ be any rational number. If $q_0,\dots,q_{n-1}$ are defined, we may choose $q_n$ such that for $i < n$, $q_i < q_n$ iff $p_i < p_n$ (this is possible as $\Q$ is dense, and $\lbrace q_0,\dots,q_{n-1}\rbrace$ is discrete). Then clearly $(P,<) \cong (\lbrace q_n : n < \omega\rbrace,<)$.
    <p align="right">$\blacksquare$</p>
  </div>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    By <a href="#lem7.8.A">Lemma 7.8.A</a> we may assume WLOG that $P \subseteq \Q$, and $<$ is the usual ordering of rationals. If $P$ is unbounded in $\Q$, we may find an unbounded sequence in $P$, which will be order-type $\omega$ (if it tends to $+\infty$) or $\omega^\ast $ (if it tends to $-\infty$). Thus we assume $P$ is bounded, say $P \subseteq [a_0,b_0]$.<br/>
    <br/>
    Now suppose $a_n,b_n$ are defined such that $P \cap [a_n,b_n] \in D$. By <a href="#lem7.5.A">Lemma 7.5.A</a>, we have that $P \cap \left[a_n,\frac{a_n + b_n}{2}\right] \in D$ or $P \cap \left[\frac{a_n + b_n}{2},b_n\right] \in D$. Let $[a_{n+1},b_{n+1}]$ be one of these two intervals such that $P \cap [a_{n+1},b_{n+1}] \in D$.<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex7.9"></a>
  <h3 class="semester-title">Exercise 7.9</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    ...
    <br/>
    <u>$\impliedby$:</u> Let $\lbrace A_n : n \in \omega\rbrace$ be a partition of $\omega$ into $\aleph_0$ pieces such that $A_n \notin D$ for all $n$. Let $f : \omega \to \omega$ be defined by:
    $$
    \begin{align*}
...
<div class="semester-section">
  <a name="ex7.10"></a>
  <h3 class="semester-title">Exercise 7.10</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    The hint basically solves the problem. We clarify some details:
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">In $X$, obviously all decreasing must be of finite length since $\boldsymbol{N}$ is well-ordered. By "The set $Y$ is handled similarly" they mean repeating the proof on the set $Y - Z$, the set of all $n$ such that $f(n) > n$ and the longest chain $n < f(n) < f^2(n) < \dots$ is finite.</li>
      <li style="margin-bottom: 6px;">If $Z_0 \in D$, then since $f_{-1}(Z_1) \cap Z = Z_0$ we have that $f_{-1}(Z_1) \in D$ by upward closure. Thus $Z_1 \in D$ as $D = f_*(D)$. But $Z_0 \cap Z_1 = \emptyset$, a contradiction. If $Z_1 \in D$, a similar contradiction can be derived.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.11"></a>
  <h3 class="semester-title">Exercise 7.11</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $f,g : \omega \to \omega$ such that $D = f_*(E)$ and $E = g_*(D)$. Then $D = f_*(g_*(D)) = (f \circ g)_*(D)$. By <a href="#ex7.10">Exercise 7.10</a>, we have $X := \lbrace n : f(g(n)) = n\rbrace \in D$. Let $Y := \ran(g\restrictedto X)$. Then $g\restrictedto X$ is one-to-one and maps onto $Y$, and that for $Z \subseteq Y$ we have:
    $$
    \begin{align*}
...
<div class="semester-section">
  <a name="ex7.14"></a>
  <h3 class="semester-title">Exercise 7.14</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We verify the axioms. Let $\mu$ denote the Lebesgue measure, and let $I$ denote the set of all sets of reals of Lebesgue measure $0$.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Clearly $\mu(\emptyset) = 0$ and $\mu(\R) = \infty$, so $\emptyset \in I$ and $\R \notin I$.</li>
      <li style="margin-bottom: 6px;">Let $\lbrace X_n : n < \omega\rbrace$ be a set of $\aleph_0$ many Lebesgue measure $0$ sets. Since $\mu$ is $\sigma$-additive, we have:
        $$
        \begin{align*}
        \mu\bb{\bigcup_{n=0}^\infty X_n} \leq \sum_{n=0}^\infty \mu(X_n) = \sum_{n=0}^\infty 0 = 0
        \end{align*}$$
      </li>
      <li style="margin-bottom: 6px;">It is a well-known theorem that the Lebesgue measure is a <strong>complete measure</strong>, i.e. every subset of measure $0$ set is measurable (and of course of measure $0$ as well). Thus $I$ is downward closed.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.15"></a>
  <h3 class="semester-title">Exercise 7.15</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We verify the axioms. Let $I$ denote the set of all meager sets.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Clearly $\emptyset$ is nowhere dense hence meager, so $\emptyset \in I$. Baire Category Theorem 4.8. tells us that $\R$ is not meager, so $\R \notin I$.</li>
      <li style="margin-bottom: 6px;">Let $\lbrace X_n : n < \omega\rbrace$ be a set of $\aleph_0$ many meager sets. For each $X_n$, suppose $X_n = \bigcup_{i=0}^\infty Y_{i,n}$, where each $Y_{i,n}$ is nowhere dense. Let $X := \bigcup_{n=0}^\infty X_n$. Then $X = \bigcup_{(i,j) \in \omega \times\omega} Y_{i,j}$, and since $\omega \times \omega$ is countable, $X$ is meager. Thus $X \in I$.</li>
      <li style="margin-bottom: 6px;">Observe that every subset of a nowhere dense set is nowhere dense. Thus, if $X = \bigcup_{n=0}^\infty X_n$, where each $X_n$ is nowhere dense, and $Y \subseteq X$, then $Y = \bigcup_{n=0}^\infty X_n \cap Y$. Each $X_n \cap Y \subseteq X_n$ is nowhere dense, so $Y$ is meager and $Y \in I$.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.16"></a>
  <h3 class="semester-title">Exercise 7.16</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We verify the axioms.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Clearly $S \supseteq \hat{P}$ for any $P \in S$, so $S \in F$. Since $\hat{P}$ are non-empty for all $P \in S$, $\emptyset \notin F$.</li>
      <li style="margin-bottom: 6px;">Let $\lbrace X_\alpha : \alpha < \lambda\rbrace$ be a set of sets in $F$, where $\lambda < \kappa$. Suppose $X_\alpha \supseteq \hat{P}_\alpha$. Observe that:
        $$
        \begin{align*}
      ...
      <li style="margin-bottom: 6px;">Clearly $F$ is upward closed.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.17"></a>
  <h3 class="semester-title">Exercise 7.17</h3>
  <div class="lemma-box">
    <a name="lem7.17.A"></a>
    <span class="status-badge lemma">Lemma 7.17.A</span>
    <br/>
    Let $B$ be a Boolean algebra and let $u,v,w \in B$. Then $u \cdot v - w = u \cdot v - u \cdot w$.
    <hr/>
    <span class="status-badge lemma">Proof</span>
    <br/>
    $$
  ...
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We first show that $(B,\oplus)$ forms an abelian group.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">(Commutativity) This follows immediately from definition and that $+$ is commutative.</li>
      <li style="margin-bottom: 6px;">(Associativity) Let $u,v,w \in B$. Then:
        $$
        \begin{align*}
      ...
      <li style="margin-bottom: 6px;">(Identity) We have $u \oplus 0 = (u - 0) + (0 - u) = u + 0 = u$, so $0$ is the additive identity.</li>
      <li style="margin-bottom: 6px;">(Inverse) We have $u \oplus u = (u - u) + (u - u) = 0 + 0 = 0$, so every element is its own inverse.</li>
    </ol>
...
<div class="semester-section">
  <a name="ex7.18"></a>
  <h3 class="semester-title">Exercise 7.18</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $B$ be a Boolean algebra with $X \subseteq B$. Let $B_X$ be the subalgebra generated by $X$ (the smallest subalgebra of $B$ containing $X$), and let $B_X' \subseteq B$ be the set of all $u \in B$ of the form stated in the question. We shall show that $B_X = B_X'$.<br/>
    <br/>
    Clearly $B_X' \subseteq B_X$ as $B_X$ is closed under $+$, $-$ and $\cdot$. Conversely, it's easy to see that $B_X'$ is itself a Boolean algebra (i.e. closed under $+$, $-$ and $\cdot$) containing $X$, and therefore $B_X \subseteq B_X'$ as $B_X$ is the <em>smallest</em> Boolean algebra containing $X$. Thus $B_X = B_X'$.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.21"></a>
  <h3 class="semester-title">Exercise 7.21</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $B$ be a finite Boolean algebra. We shall prove this exercise in a series of claims.
    <div class="lemma-box" style="margin-top: 12px;">
      <span class="status-badge lemma">Claim</span>
      <br/>
      For any non-zero $u \in B$, there exists an atom $a \leq u$. In particular, $B$ is atomic.
      <hr/>
      <span class="status-badge lemma">Proof</span>
      <br/>
      Let $u \in B$ and suppose there is no atom $a \leq u$. Then in particular $u$ is not an atom, so we may obtain $a_0 < u$. $a_0$ is again not an atom, so we obtain another element $a_1 < a_0$. By repeating this, we obtain an infinite descending chain of non-zero elements $u > a_0 > a_1 > \dots$, contradicting that $B$ is finite.
      <p align="right">$\blacksquare$</p>
    </div>
    ...
    <div class="lemma-box" style="margin-top: 12px;">
      <span class="status-badge lemma">Claim</span>
      <br/>
      Every element $u \in B$ is of the form $u = a_{i_1} + \dots + a_{i_k}$ for some $1 \leq i_1 < \dots < i_k \leq n$.
      <hr/>
      <span class="status-badge lemma">Proof</span>
      <br/>
      Fix $u \in B$. Since $A$ is a partition of $B$, we have that $u = \sum_{i=1}^n u \cdot a_i$. But $u \cdot a_i \leq a_i$ and $a_i$ is an atom, so $u \cdot a_i = 0$ or $a_i$.
      <p align="right">$\blacksquare$</p>
    </div>
...
<div class="semester-section">
  <a name="ex7.22"></a>
  <h3 class="semester-title">Exercise 7.22</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    The approach we provide here is widely known as the "back-and-forth argument".<br/>
    <br/>
    ...
    \pi(y_{i,j}) := w_{i,j}
    \end{align*}$$
    and extend to the rest of the elements in the algebra by addition (see the last claim of the proof of <a href="#ex7.21">Exercise 7.21</a>). Then $\pi$ extends the original $\pi\restrictedto \c{a_0,\dots,a_{n-1}}$ and is a one-to-one Boolean algebra homomorphism (any map defined on atoms then extended to the algebra by addition is a homomorphism).<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex7.23"></a>
  <h3 class="semester-title">Exercise 7.23</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We define $\pi : B\restrictedto a \to B/I$ by:
    $$
    \begin{align*}
    \pi(u) := [u]
    \end{align*}$$
...
<div class="semester-section">
  ...
  <div class="lemma-box">
    ...
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Clearly $1 \in G$. $0 \notin G$ as, as mentioned in the first paragraph above, $w \cdot u \neq 0$ for all $w \in F$.</li>
      <li style="margin-bottom: 6px;">Let $v_1,v_2 \in G$. Let $w_1,w_2 \in F$ such that $w_1 \cdot u \leq v_1$ and $w_2 \cdot u \leq v_2$. Then $w_1 \cdot w_2 \in F$, and $(w_1 \cdot w_2) \cdot u \leq v_1 \cdot v_2$, so $v_1 \cdot v_2 \in G$.</li>
      <li style="margin-bottom: 6px;">Clearly $G$ is upward closed.</li>
    </ol>
  ...
  <div class="solution-box">
    ...
    <br/>
    Now $U$ is a subset of $B$ that satisfies the FIP, so let $U'$ be the filter in $B$ generated by $U$. By the observation in the previous paragraph, we have that $u \notin U'$ and $-u \notin U'$. By <a href="#lem7.24.A">Lemma 7.24.A</a>, there exists ultrafilters $F,G \supseteq U'$ such that $u \in F$ and $u \notin G$. Furthermore, $U \subseteq F \cap A$ and $U \subseteq G \cap A$, but both $F \cap A$ and $G \cap A$ are ultrafilters of $A$, so we have $F \cap A = U = G \cap A$.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.25"></a>
  <h3 class="semester-title">Exercise 7.25</h3>
  <div class="lemma-box">
    <a name="lem7.25.A"></a>
    <span class="status-badge lemma">Lemma 7.25.A</span>
    <br/>
    Let $B$ be a Boolean algebra. Let $X \subseteq B$ be an infinite set, and let $A$ be the subalgebra generated by $X$. Then $\vert X\vert  = \vert A\vert $.
    <hr/>
    <span class="status-badge lemma">Proof</span>
    <br/>
    Clearly $\vert A\vert  \geq \vert X\vert $. Conversely, by repeating the proof of <a href="#ex7.18">Exercise 7.18</a>, we see that there are $\lambda$ many finite partial maps $\pi : Y \to \lbrace -1,0,1\rbrace$, where $\vert X\vert  = \lambda$ and $Y \subseteq X$ is finite. This yields a map of the set of finite sets of such partial maps $\pi$ onto $A$, which is of course of size $\lambda$ as well. Thus $\vert A\vert  \leq \vert X\vert $.
    <p align="right">$\blacksquare$</p>
  </div>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $B$ be an infinite Boolean algebra, $\vert B\vert  = \kappa$. We show there are at least $\kappa$ ultrafilters on $B$.<br/>
    <br/>
    Let $S$ denote the set of all ultrafilters on $B$. As in the hint, let $A$ denote the subalgebra generated by the an element picked in $F - G$ for each $(F,G) \in S \times S$, $F \neq G$. The subalgebra $A$ is generated by a set $X$ of cardinality $\lambda < \kappa$, so by <a href="#lem7.25.A">Lemma 7.25.A</a> we have that $\vert A\vert  \leq \vert S \times S\vert  = \vert S\vert $.<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex7.26"></a>
  <h3 class="semester-title">Exercise 7.26</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    It suffices to show that the identity in the hint holds. Assume that all sums in $B$ exist. For $X \subseteq B$, let $v := \sum\lbrace u : u \leq x \text{ for all } x \in X\rbrace$. We observe that if $u \leq x$ for all $x \in X$, then $u \leq v$ by definition. Thus, it remains to show that $v$ is indeed a lower bound.<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex7.27"></a>
  <h3 class="semester-title">Exercise 7.27</h3>
  <a name="ex7.27(i)"></a>
  <p class="sub-exercise-title">Exercise 7.27(i)</p>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Let $Y := \lbrace a \cdot u : u \in X\rbrace$. Let $v := \sum\lbrace u : u \in X\rbrace$. Then for all $u \in X$, $a \cdot v \geq a \cdot u$, so $a \cdot v$ is an upper bound of $Y$. To see that it is the least upper bound, let $w \in B$ be such that $a \cdot u \leq w$ for all $u \in X$. Then $u = (-a) \cdot u + a \cdot u \leq (-a) \cdot v + w$ for all $u \in X$, and since $v$ is the least upper bound of $X$, we have that $v \leq (-a) \cdot v + w$. Then $a \cdot v \leq a \cdot (-a) \cdot v + a \cdot w = a \cdot w \leq w$, so $a \cdot v$ is the least upper bound.</li>
      <li style="margin-bottom: 6px;">Let $Y := \lbrace a + u : u \in X\rbrace$. Let $v := \prod\lbrace u : u \in X\rbrace$. Then for all $u \in X$, $a + v \leq a + u$, so $a + v$ is a lower bound of $Y$. To see that it is the greatest lower bound, let $w \in B$ be such that $w \leq a + u$ for all $u \in X$. Then $(-a) \cdot w \leq (-a) \cdot a + (-a) \cdot u = (-a) \cdot u$ for all $u \in X$, so by (1) above we have that $(-a) \cdot w \leq (-a) \cdot v$. Then $w \leq a + w = a + (-a) \cdot w \leq a + (-a) \cdot v = a + v$, so $a + v$ is the greatest lower bound.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
  <a name="ex7.27(ii)"></a>
  <p class="sub-exercise-title">Exercise 7.27(ii)</p>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $Y := \lbrace -u : u \in X\rbrace$.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Let $v := \sum\lbrace u : u \in X\rbrace$. Then since $u \leq v$ for all $u \in X$, $-v \leq -u$ for all $u \in X$ so $-v$ is a lower bound. If $w \leq -u$ for all $u \in X$, then $u \leq -w$ for all $u \in X$, so $v \leq -w$ as $v$ is the least upper bound of $X$. Thus $w \leq -v$, so $-v$ is the greatest lower bound of $Y$.</li>
      <li style="margin-bottom: 6px;">This follows from (1), by replacing $X$ with $Y$.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  ...
  <div class="solution-box">
    ...
    &= v + u \cdot (-c)
    \end{align*}$$
    Observe that $f(u) = v \cdot f(c) \leq f(c)$, so $u \leq c$. Thus $u \cdot (-c) = 0$, and therefore:
    $$
    \begin{align*}
    g(u + v \cdot (-c)) = v
    \end{align*}$$
...
<div class="semester-section">
  <a name="ex7.29"></a>
  <h3 class="semester-title">Exercise 7.29</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    The hint basically solves the problem. Note that:
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">$v$ is well-defined as if $a \leq u \leq b$, then in particular $a \leq b \implies h(a) \leq h(b)$. Thus $h(a)$ is a lower bound of $\lbrace h(b) : b \in A, u \leq b\rbrace$, vice versa. Of course the sums exist.</li>
      <li style="margin-bottom: 6px;">By <a href="#ex7.19">Exercise 7.19</a>, to extend $h$ to $A(u)$ it suffices to define $h(a \cdot u + b \cdot (-u)) = h(a) \cdot v + h(b) \cdot (-v)$. The proof that $h$ respects $+$, $\cdot$ and $-$ is similar to the computation in <a href="#ex7.19">Exercise 7.19</a>.</li>
    </ol>
...
<div class="semester-section">
  <a name="ex7.30"></a>
  <h3 class="semester-title">Exercise 7.30</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let:
    ...
    <br/>
    By Zorn's Lemma we obtain a maximal element $f \in \F$. Then $\dom(f) = B$ - otherwise, let $u \in B - \dom(f)$. By <a href="#ex7.29">Exercise 7.29</a> it is possible to extend $f$ to a larger homomorphism $f'$ on the subalgebra generated by $\dom(f) \cup \lbrace u\rbrace$, so $f \subsetneq f'$. This contradicts the maximality of $f$.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex7.31"></a>
  <h3 class="semester-title">Exercise 7.31</h3>
...
<div class="semester-section">
  <a name="ex7.32"></a>
  <h3 class="semester-title">Exercise 7.32</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We expand on the hint. In the first case where $\vert B\restrictedto a\vert  = \vert B\vert $, since $B$ is an infinite complete Boolean algebra, by Theorem 7.15 we have $\sat(B)$ is regular uncountable. In particular, there exists a countable partition of $B$, call it $W = \lbrace a_n : n < \omega\rbrace$.<br/>
    <br/>
    ...
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">Suppose there exists a $b \leq a$ that is atomic. Then the only elements below $b$ are $0$ and $b$ itself, thus $b$ is stable.</li>
      <li style="margin-bottom: 6px;">Suppose every element below $a$ is not atomic. If no elements below $a$ are stable, then for all $b \leq a$ there exists $c < b$ such that $\vert B\restrictedto c\vert  < \vert B\restrictedto b\vert $. Then there exists a decreasing sequence $a > a_1 > a_2 > \dots$ such that $\vert B\restrictedto a_{n+1}\vert  < \vert B\restrictedto a_n\vert $ for all $n$, which is not possible.</li>
    </ol>
...
<div class="semester-section">
  <a name="ex7.33"></a>
  <h3 class="semester-title">Exercise 7.33</h3>
  <div class="lemma-box">
    <a name="lem7.33.A"></a>
    <span class="status-badge lemma">Lemma 7.33.A</span>
    <br/>
    Let $X \subseteq B$. Let $U := \lbrace u \in B : (\exists v \in X) \, v \leq x\rbrace$. Then $U$ is open. Furthermore, if $\sum U$ exists, then so does $\sum X$, and $\sum X = \sum U$.
    <hr/>
    <span class="status-badge lemma">Proof</span>
    <br/>
