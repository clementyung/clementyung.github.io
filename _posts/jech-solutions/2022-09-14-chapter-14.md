...
&= \sum_{t \in \dom{x}} x(t) \cdot \bb{\sum_{y \in V^B} \Verty = t\Vert \cdot \Vert\varphi(y)\Vert} \\<br/>
&= \sum_{t \in \dom{x}} x(t) \cdot \bb{\sum_{y \in V^B} \Verty = t \wedge \varphi(y)\Vert} \\<br/>
&= \sum_{t \in \dom{x}} x(t) \cdot \bb{\sum_{y \in V^B} \Verty = t \wedge \varphi(t)\Vert} \\<br/>
&= \sum_{t \in \dom{x}} x(t) \cdot \bb{\sum_{y \in V^B} \Verty = t\Vert \cdot \Vert\varphi(t)\Vert} \\<br/>
...
$$
\begin{align*}
\Vert\check{x} \subseteq \check{y}\Vert &= \prod_{t \in \dom{\check{x}}} (\check{x}(t) \to \Vertt \in \check{y}\Vert) \\<br/>
