...
<b>Lemma 10.3.A.</b> Let $\mu$ be an atomless measure on $S$. For all $\epsilon > 0$ and $X \subseteq S$, there exists $Y \subseteq S$ such that $0 < \mu(Y) < \epsilon$.<br/>
<br/>
...
<a name="ex10.4"></a><br/>
<h2>Exercise 10.4.</h2>
<i>Solution.</i> Let $\mu,U$ be a two-valued measure/ultrafilter over a set $X$.<br/>
<br/>
...
<br/>
If $\mu(X_\alpha) = 0$ for all $\alpha < \kappa$, then $\mu(X - X_\alpha) = 1$ for all $\alpha < \kappa$. By $\kappa$-completeness of $U$, we have that $\bigcap_{\alpha < \kappa} X - X_\alpha = X - \bigcup_{\alpha < \kappa} X_\alpha \in U$. Thus, $\mu\bb{X - \bigcup_{\alpha < \kappa} X_\alpha} = 1$, so $\mu\bb{\bigcup_{\alpha < \kappa} X_\alpha} = 0 = \sum_{\alpha < \kappa} \mu(X_\alpha)$.<br/>
l\end{solution}<br/>
<br/>
<a name="ex10.5"></a><br/>
<h2>Exercise 10.5.</h2>
<i>Solution.</i> By "least" here we refer to the ordering $<$ on the set of all functions on $\kappa$ in the proof of Theorem 10.20. That is:<br/>
$$
\begin{align*}<br/>
