...
<br/>
<i>Proof.</i> If $Y \in I$, then $X - Y \in F$ and $Y \cap (X - Y) = \emptyset$. On the other hand, if $Z \cap Y = \emptyset$ and $Z \in F$, then $Z \subseteq X - Y$ and by upward closure $X - Y \in F$. Thus $Y \in I$.<p align="right">$\blacksquare$</p><br/>
<br/>
<i>Solution.</i> Let $F$ be the dual filter of $I$.<br/>
<br/>
...
<br/>
<b>(ii) Limit Case:</b> It is almost verbatim to the working of the successor singular cardinal case (replace $\lambda^+$ with just regular limit $\lambda$).<br/>
<br/>
