...
<div class="semester-section">
  <a name="ex23.1"></a>
  <h3 class="semester-title">Exercise 23.1</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    The proof of Theorem 23.3 can be replicated with $E_\lambda^\kappa$ replaced by $E$. We provide more details.<br/>
    <br/>
    We define $C_\nu$, $c_\alpha^\nu$, $c_\alpha$ as in the proof of Theorem 23.3. Then $S := \Lim(C) \cap E = \lbrace \alpha \in E_\lambda^\kappa : C \cap \alpha \text{ is unbounded in } \alpha\rbrace$ is stationary, as $\Lim(C)$ is closed unbounded. We claim that for each $\alpha \in S$, there exists a $\nu(\alpha) < \lambda^+$ such that $c_\alpha = c_\alpha^{\nu(\alpha)}$ — otherwise, there exists an unbounded sequence $\lbrace \nu_\gamma : \gamma < \lambda^+\rbrace$ (which is of size $\lambda^+$ as $\lambda^+$ is regular) such that $c_\alpha = \bigcup_{\beta<\lambda^+} \bb{c_\alpha^\beta - \bigcup_{\gamma < \beta} c_\alpha^\gamma}$, and each $c_\alpha^\beta - \bigcup_{\gamma < \beta} c_\alpha^\gamma$ is pairwise disjoint and non-empty. Then $\vert c_\alpha\vert  = \lambda^+$, but $c_\alpha \subseteq c_\alpha^0$ and $\vert c_\alpha^0\vert  = \lambda$, a contradiction.<br/>
    <br/>
    Therefore, the map $\nu$ is regressive on the stationary set $S \cap \lbrace \alpha < \kappa : \alpha > \lambda^+\rbrace$, so by Fodor's theorem it takes a constant value on a stationary set $T$; call this value $\nu$. Then for all $\alpha \in T$, $c_\alpha^\nu \subseteq C_\nu$, and since $T \subseteq S$ we have that $c_\alpha^\nu \subseteq \alpha$ is closed unbounded. This contradicts the choice of $C_\nu$.
...
<div class="semester-section">
  <a name="ex23.2"></a>
  <h3 class="semester-title">Exercise 23.2</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We expand on the hint. Note that in the hint, they denote $\Lim(X)$ by $X'$.<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex23.3"></a>
  <h3 class="semester-title">Exercise 23.3</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $P$ be the notion of forcing in the hint. We shall show that this $P$ works.<br/>
    <br/>
    <u>$P$ is $\aleph_0$-closed:</u> Let $p_0 \subseteq p_1 \subseteq \dots$ be an increasing $\omega$-sequence of conditions. Write $p_n = \c{C_\alpha : \alpha \leq \gamma_n}$, and let $\gamma := \lim_{n \to \omega} \gamma_n$. Note that $\gamma < \omega_2$ as $\omega_2$ is regular. Let $C_\gamma := \lbrace \gamma_n + 1 : n < \omega\rbrace$. Then clearly $C_\gamma$ is closed unbounded in $\gamma$, so (i) of (23.4) is satisfied. $C_\gamma$ contains no limit ordinals, so (ii) of (23.4) is trivially satisfied. Finally, observing that $\cf(\gamma) = \omega < \omega_1$, we have $\vert C_\gamma\vert  = \aleph_0 < \aleph_1$. Thus $\c{C_\alpha : \alpha \leq \gamma} \in P$ is stronger than all of $p_n$.<br/>
    <br/>
    ...
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">If $\alpha = \omega$, let $C_{\gamma_\omega} := \lbrace \gamma_n + 1 : n < \omega\rbrace$.</li>
      <li style="margin-bottom: 6px;">If $\Lim(\alpha)$ is bounded, let $\beta$ be the largest limit ordinal below $\alpha$. Fix a countable sequence $\lbrace \xi_n : n < \omega\rbrace$ cofinal in $\alpha$ such that $\xi_0 > \gamma_\beta$. Let:
        $$
        \begin{align*}
        C_{\gamma_\alpha} := C_{\gamma_\beta} \cup \lbrace \gamma_\beta\rbrace \cup \lbrace \xi_n + 1 : n < \omega\rbrace
        \end{align*}$$
      </li>
      <li style="margin-bottom: 6px;">If $\Lim(\alpha)$ is unbounded, let:
        $$
        \begin{align*}
    ...
    We shall induct on limit ordinals $\alpha$ that $C_{\gamma_\alpha} \subseteq \gamma_\alpha$ is closed unbounded, countable (so (iii) of (23.4) is satisfied), satisfies (ii) of (23.4), and if $\beta < \alpha$ is a limit ordinal then $C_{\gamma_\beta}$ is an initial segment of $C_{\gamma_\alpha}$.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">The case for $\alpha = \omega$ is done as in the proof above that $P$ is $\aleph_0$-closed.</li>
      <li style="margin-bottom: 6px;">Suppose $\Lim(\alpha)$ is bounded. Let $\lbrace \delta_\xi : \xi < \alpha'\rbrace \subseteq C_{\gamma_\alpha}$ be a sequence, and let $\delta := \sup_{\xi<\alpha'} \delta_\xi$. If $\delta > \gamma_\beta$, then the sequence must be unbounded as $\xi_n + 1$ are not limit ordinals. Otherwise, the sequence must lie in $C_{\gamma_\beta}$. Since $\gamma_\beta \in C_{\gamma_\alpha}$ and $C_{\gamma_\beta}$ is closed unbounded, $\delta \in C_{\gamma_\beta} \cup \lbrace \gamma_\beta\rbrace$ necessarily. Thus $C_{\gamma_\alpha}$ is closed in $\gamma_\alpha$.<br/>
        <br/>
        Since $C_{\gamma_\beta}$ is countable by induction hypothesis, so is $C_{\gamma_\alpha}$.<br/>
        <br/>
        Let $\delta \in \Lim(C_{\gamma_\alpha})$. Then $\delta \leq \gamma_\beta$, as $\xi_n + 1$ are not limit ordinals. If $\delta = \gamma_\beta$, then since $\xi_0 > \gamma_\beta$ we have $C_{\gamma_\alpha} \cap \gamma_\beta = C_{\gamma_\beta}$. If $\delta < \gamma_\beta$, then $\delta \in \Lim(C_{\gamma_\beta})$, so by induction hypothesis $C_{\gamma_\alpha} \cap \delta = C_{\gamma_\beta} \cap \delta = C_\delta$. In particular, if $\delta = \gamma_\xi$ for some limit $\xi < \alpha$, then $C_{\gamma_\alpha} \cap \gamma_\xi = C_{\gamma_\xi}$.</li>
      <li style="margin-bottom: 6px;">Suppose $\Lim(\alpha)$ is unbounded. Let $\lbrace \delta_\xi : \xi < \alpha'\rbrace \subseteq C_{\gamma_\alpha}$ be a sequence, and let $\delta := \sup_{\xi<\alpha'} \delta_\xi$. Clearly $\delta \leq \gamma_\alpha$, and if $\delta = \gamma_\alpha$ there is no problem. Otherwise, $\delta \leq \gamma_\beta$ for some $\beta \in \Lim(\alpha)$. Let $\beta' \in \Lim(\alpha)$ be such that $\beta' > \beta$. Then the sequence is a bounded sequence that lies entirely in $C_{\gamma_{\beta'}}$, which is closed unbounded in $\gamma_{\beta'}$ by induction hypothesis. Thus $\delta \in C_{\gamma_{\beta'}} \subseteq C_{\gamma_\alpha}$.<br/>
        <br/>
        ...
        <br/>
        Let $\delta \in \Lim(C_{\gamma_\alpha})$. Then $\delta \in \Lim(C_{\gamma_\beta})$ for some $\beta \in \Lim(\alpha)$. By induction hypothesis, for all $\beta' \geq \beta$ with $\beta' \in \Lim(\alpha)$, $C_{\gamma_{\beta'}} \cap \delta = C_\delta$. Thus:
        $$
        \begin{align*}
...
<div class="semester-section">
  <a name="ex23.4"></a>
  <h3 class="semester-title">Exercise 23.4</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Let $\c{\alpha_\gamma : \gamma < \cf(\alpha)}$ be an increasing sequence cofinal in $\alpha$. For each $\gamma < \cf(\alpha)$, define:
    $$
    \begin{align*}
    \alpha_\gamma' :=
    \begin{cases}
    \alpha_\gamma + 1, &\text{if $\gamma$ is not a limit ordinal} \\
    \sup_{\xi < \gamma} \alpha_\xi, &\text{otherwise}
    \end{cases}
    \end{align*}$$
    Then clearly $\c{\alpha_\gamma' : \gamma < \cf(\alpha)}$ is a normal sequence cofinal in $\alpha$ such that $\alpha_\gamma'$ is a limit ordinal iff $\gamma$ is a limit ordinal. Also, if $\gamma$ is a limit ordinal then $\cf(\alpha_\gamma') = \cf(\gamma) < \cf(\alpha)$. Thus, if we let $C := \lbrace \alpha_\gamma' : \gamma < \cf(\alpha)\rbrace$, then $C$ is closed unbounded in $\alpha$ with the property in the hint. Thus $S$ does not reflect at $\alpha$.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex23.5"></a>
  <h3 class="semester-title">Exercise 23.5</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We note that:
...
<div class="semester-section">
  <a name="ex23.6"></a>
  <h3 class="semester-title">Exercise 23.6</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Following the hint and the proof of Lemma 23.9, let $A_0 := \lbrace p\rbrace$, and if $\alpha$ is a limit ordinal let $A_\alpha := \bigcup_{\beta<\alpha} A_\beta$. For each $\alpha$, we let $\gamma_\alpha := \sup\lbrace \max(q) : q \in A_\alpha\rbrace$, and define:
    $$
    \begin{align*}
...
<div class="semester-section">
  <a name="ex23.7"></a>
  <h3 class="semester-title">Exercise 23.7</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We attempt to mimic the proof of Lemma 23.9, and use the additional assumptions to patch the gaps.<br/>
    <br/>
    ...
    <br/>
    The sequence $\c{\gamma_\alpha : \alpha < \omega_1}$ is normal, so $C := \lbrace \lambda < \omega_2 : \text{if $\alpha < \lambda$ then $\gamma_\alpha < \lambda$}\rbrace$ is closed unbounded. Since $S \cap E_{\aleph_1}^{\aleph_2}$ is stationary, we may obtain a limit ordinal $\lambda \in C \cap S \cap E_{\aleph_1}^{\aleph_2}$. Let $\c{\alpha_\xi : \xi < \omega_1}$ be a sequence cofinal in $\lambda$.<br/>
    <br/>
    We define a sequence $\c{p_\xi : \xi < \omega_1}$ as follows: Let $p_0 = p$. Define $p_{\xi+1}$ such that $p_{\xi+1} \in A_{\alpha_\xi}$, $p_{\xi+1} \leq p_\xi$ and $p_{\xi+1}$ decides $\dot{f}(\xi)$. Suppose $\xi$ is a limit ordinal. Let $\mu := \sup_{\delta<\xi} \max(p_\delta)$. Then $\mu < \lambda$ is a limit ordinal such that $\cf(\mu) = \omega$, and since $E_{\aleph_0}^{\aleph_2} \subseteq S$, $\mu \in S$. Thus let $p_\xi := \bigcup_{\delta < \xi} p_\delta \cup \lbrace \mu\rbrace$. Then $p_\xi$ is a closed bounded subset of $S$, so $p_\xi \in P$, and $p_\xi \leq p_\delta$ for all $\delta < \xi$.<br/>
    <br/>
    We may then finish the proof the same way as that of Lemma 23.9: We have $\lim_\xi \max(p_\xi) = \lambda$, so $q := \bigcup_{\xi<\omega_1} p_\xi \cup \lbrace \lambda\rbrace \in P$ is a condition such that $q \leq p_\xi$ for all $\xi < \omega_1$. Thus $q$ decides all of $\dot{f}(\xi)$, so there exists some $f$ such that $q \forces \dot{f} = f$.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex23.8"></a>
  <h3 class="semester-title">Exercise 23.8</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    Inaccessibility is not required — it suffices for $\kappa$ to be regular.<br/>
    <br/>
...
<div class="semester-section">
  <a name="ex23.10"></a>
  <h3 class="semester-title">Exercise 23.10</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    We shall show that when $\kappa$ is regular, every almost disjoint family is strongly almost disjoint, and therefore the existence of a strongly almost disjoint family follows from Lemma 9.22.<br/>
    <br/>
    Let $\lbrace X_\xi : \xi < \kappa^+\rbrace$ be an almost disjoint family. By definition, $\vert X_\xi\vert  = \kappa$ for all $\xi$, and these are hence unbounded as $\kappa$ is regular. Let $\theta < \kappa^+$, and write $\lbrace X_\xi : \xi < \theta\rbrace = \lbrace Y_\zeta : \zeta < \vert \theta\vert \rbrace$, where $Y_\zeta \neq Y_{\zeta'}$ for $\zeta \neq \zeta'$. For each $\zeta' < \zeta$, we have $\vert Y_\zeta \cap Y_{\zeta'}\vert  < \kappa$, so there exists some $\delta_{\zeta',\zeta} < \kappa$ such that $Y_\zeta \cap Y_{\zeta'} \subseteq \delta_{\zeta',\zeta}$. Let:
    $$
    \begin{align*}
    \delta_\zeta := \max\ss{\sup_{\zeta'<\zeta} \delta_{\zeta',\zeta},\sup_{\zeta'<\zeta} \delta_{\zeta'}}
    \end{align*}$$
    Since $\kappa$ is regular (and by induction hypothesis $\delta_{\zeta'} < \kappa$ for all $\zeta' < \zeta$), $\delta_\zeta < \kappa$. Then clearly $Y_{\zeta'} \cap Y_\zeta \subseteq \delta_\zeta$ for all $\zeta' < \zeta$, and therefore $(Y_{\zeta'} - \delta_{\zeta'}) \cap (Y_\zeta - \delta_\zeta) = \emptyset$. Since $\lbrace X_\xi : \xi < \theta\rbrace = \lbrace Y_\zeta : \zeta < \vert \theta\vert \rbrace$, $\lbrace X_\xi : \xi < \kappa^+\rbrace$ is strongly almost disjoint.
    <p align="right">$\square$</p>
  </div>
</div>
...
<div class="semester-section">
  <a name="ex23.11"></a>
  <h3 class="semester-title">Exercise 23.11</h3>
  <div class="solution-box">
    <span class="status-badge success">Solution</span>
    <br/>
    The hint solves the problem. We provide the details.
    <ol style="margin: 8px 0; padding-left: 1.5em;">
      <li style="margin-bottom: 6px;">For each $i \neq j$, $S_i \cap S_j$ is non-stationary, so $\omega_1 - (S_i \cap S_j)$ has a closed unbounded subset in $V[G]$. By the c.c.c. of Cohen forcing and Lemma 22.25, $\omega_1 - (S_i \cap S_j)$ has a closed unbounded subset $\forces \omega_1 - A_{i,j} \subseteq \omega_1 - (S_i \cap S_j)$, where $A_{i,j} \in V$. Then $\forces S_i \cap S_j \subseteq A_{i,j}$.</li>
      <li style="margin-bottom: 6px;">In the ground model $V$, by $\GCH$ we have that $\sat(I_\mathrm{NS}) \leq 2^{\aleph_1} = \aleph_2$. Thus the partition $\lbrace i,j\rbrace \to A_{i,j}$ has at most $\aleph_2$ colours. Also in the ground model, by <a href="../chapter-9#ex9.2">Exercise 9.2</a> we have that $(\exp_1(\aleph_2))^+ \to (\aleph_3)_{\aleph_2}^2$. Under $\GCH$, we have $(\exp_1(\aleph_2))^+ = \aleph_4$.</li>
      <li style="margin-bottom: 6px;">Since $A$ is non-stationary, $\omega_1 - A$ has a closed unbounded subset, so $S_i - A = S_i \cap (\omega_1 - A)$ remains stationary, and in particular unbounded. Thus $\lbrace S_i - A : i \in H\rbrace$ gives $\aleph_3$ disjoint stationary subsets of $\omega_1$ in $V[G]$, yielding the required contradiction.</li>
    </ol>
    <p align="right">$\square$</p>
  </div>
</div>
